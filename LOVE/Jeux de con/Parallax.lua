...
function Parallax:Create(width, height)
    ...
    self.__index = self
    self.BackGrounds1 = BackGround:Create(20,width, height)
    self.BackGrounds2 = BackGround:Create(40,width, height)
    self.BackGrounds3 = BackGround:Create(70,width, height)
    self.BackGrounds4 = BackGround:Create(90, width, height)
    self.BackGrounds12 = BackGround:Create(20,width, height)
    self.BackGrounds22 = BackGround:Create(40, width, height)
    self.BackGrounds32 = BackGround:Create(70,width, height)
    self.BackGrounds42 = BackGround:Create(90, width, height)
